...
import kuroneko.fun.system.platform.admin.mapper.SysUserMapper;
import kuroneko.fun.system.platform.admin.mapper.SysUserRoleMapper;
...
public class SysUserServiceImpl implements SysUserService {
  ...
  public PageResult findPage(PageRequest pageRequest) {
    ...
    if (name != null) {
      if (email != null) {
        pageResult =
            MybatisPageHelper.findPage(
                pageRequest, sysUserMapper, "findPageByNameAndEmail", name, email);
      } else {
