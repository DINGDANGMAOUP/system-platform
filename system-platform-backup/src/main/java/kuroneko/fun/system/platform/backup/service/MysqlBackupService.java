...
public interface MysqlBackupService {
	 ...
	 * @throws Exception
	 */
	boolean backup(String host, String userName, String password, String backupFolderPath, String fileName, String database,String dockerName) throws Exception;
    /**
     * 恢复数据库
	 ...
	 * @throws Exception
	 */
	boolean restore(String restoreFilePath, String host, String userName, String password, String database,String dockerName) throws Exception;
